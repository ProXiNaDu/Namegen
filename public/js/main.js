;(function(){
	...
	function toggleList() {
		patternListWrap.classList.toggle('open');
	}
	...
	closeEditorButt.addEventListener('click', closeEditor);
	docsButt.addEventListener('click', openDocs);
	closeDocsButt.addEventListener('click', closeDocs);
	addSymbolButt.addEventListener('click', addSymbolLi);
	patternListWrap.addEventListener('click', toggleList);
